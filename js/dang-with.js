document.addEventListener('DOMContentLoaded', () => {
      ...
      document.querySelectorAll('.nav-btn').forEach(btn => {
        ...
        if (routeAttribute) {
          ...
          // dang-with.html 페이지는 특정 하단 탭을 active로 하지 않음 (필요시 수정)
      ...
      // --- 여기까지 공통 네비게이션 로직 (dang-with.html용으로 active 설정 부분은 주석 처리) ---

      // 가로 스크롤 리스트 (이 페이지에서는 카드가 세로로 나열되므로 필요 없을 수 있음. 필요시 주석 해제)
      /*
